...
const Contactus = () => {
    ...
    const handlesubmit = () =>{
        window.open(`mailto:bida.endri1@gmail.com?subject=Sample&body=${body}`)
    }
            ...
            <div className="showAdrss">
                <div className="box">
                    ...
                    <div className="adressCtn">
                        <h3> Address</h3>
                        <p>Rruga Abdi Toptani 18, 1001 Tirana Albania</p>
                    </div>
                </div>
                    <div className="box">
                    ...
                    <div className="adressCtn">
                        <h3>Lets Talk</h3>
                        <p className="infoCtn">000000000000</p>
                    </div>
                </div>
                <div className="box">
                    ...
                    <div className="adressCtn">
                        <h3>Sale Support</h3>
                        <p className="infoCtn">albaniamarket@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
